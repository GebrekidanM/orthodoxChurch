    ...
    <div className="max-w-3xl mx-auto p-6 bg-gray-300 rounded-lg shadow-md text-neutral-900">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className='flex flex-col gap-2'>
            <label>Summary: <small className="text-red-400">less than 100 characters.</small></label>
            <textarea onChange={e => setSummary(e.target.value)} className='px-2 p-1 rounded-sm outline-none bg-neutral-100 text-neutral-900'></textarea>
        </div>
